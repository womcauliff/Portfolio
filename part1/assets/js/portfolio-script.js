...
function enable_arrows( dataslide ) {
	...
	// disable up-arrow for first slide
	if ( dataslide != 1 ) {
		$('#arrow-up').removeClass('disabled');
	}
	// disable down-arrow for final slide
	if ( dataslide != 1 ) {
		$('#arrow-down').removeClass('disabled');
	}
	// enable left/right-arrows for portfolio slide
	if ( dataslide == 1 ) {
...
// 		var offset_top = ( dataslide == 3 ) ? '0px' : $('.slide[data-slide="' + dataslide + '"]').offset().top;
